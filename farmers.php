        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card sidebar-menu">
                    ...
                    <br>
                        <li class="nav-item"><a href="#dl" class="nav-link">Dal</a></li>
                        <li class="nav-item"><a href="#chna" class="nav-link">Rice, Wheat & Beans</a></li>
            ...
            <section class="text-center my-5"><br>
                ...
                <div class="row">
                    <div class="col-md-12 mb-md-0 mb-4">
                        <div class="card card-image" style="background-image: url('./img/vbx.png');background-repeat: no-repeat;background-position:center">
                        ...
                        <div class="owl-carousel owl-theme mt-3"  style="height:350px;">
                                <div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            <div class="mb-1"><b class="text-left">Chana</b></div>
                                            <img src="img/cd.jpg" class="img-fluid" alt="">
                                        </div>
								 ...
								 <div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            <div class="mb-1"><b class="text-left">Chana Sabut</b></div>
                                            <img src="img/chi.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="card-footer px-1">
                                            <span class="float-left font-weight-bold">
                                                <strong class="price">₹130</strong>
                                ...
                                <div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            <div class="mb-1"><b class="text-left">Dry Pees</b></div>
                                            <img src="img/hm.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="card-footer px-1">
                                            <span class="float-left font-weight-bold">
                                ...
                                <div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            ...
                                            <img src="img/md.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="card-footer px-1">
                                            <span class="float-left font-weight-bold">
                                                <strong class="price">₹1439</strong>
                        ...
                        <!-- Collection card -->
                                ...
                                <div class="text-left" id="chna">
								 <h3 class=" font-weight-bold">
                                    <strong>Rice, Wheat & Beans</strong>
                        ...
                        <div class="owl-carousel owl-theme" style="height: 350px;">
                                ...
                                <div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            <div class="mb-1"><b class="text-left">Basmati Rice</b></div>
                                            <img src="img/brx.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="card-footer px-1">
                                            <span class="float-left font-weight-bold">
                                ...
                                <div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            <div class="mb-1"><b class="text-left">Broken Rice</b></div>
                                            <img src="img/br.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="card-footer px-1">
                                            <span class="float-left font-weight-bold">
                                ...
                                <div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            <div class="mb-1"><b class="text-left">Kidney Beans</b></div>
                                            <img src="img/cb.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="card-footer px-1">
                                            <span class="float-left font-weight-bold">
                                ...
                                <div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            <div class="mb-1"><b class="text-left">Millet Flour</b></div>
                                            <img src="img/product-slider/millet.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="card-footer px-1">
                                            <span class="float-left font-weight-bold">
                                                <strong class="price">₹1439</strong>
                                ...
                                <div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            <div class="mb-1"><b class="text-left">Jowar Flour</b></div>
                                            <img src="img/product-slider/jowar.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="card-footer px-1">
                                            <span class="float-left font-weight-bold">
                                                <strong class="price">₹1439</strong>
                                ...
                                <div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            <div class="mb-1"><b class="text-left">Coconut Flour</b></div>
                                            <img src="img/product-slider/coconut.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="card-footer px-1">
                                            <span class="float-left font-weight-bold">
                                                <strong class="price">₹1439</strong>
								...
								<div class="item">
                                    <div class=" card collection-card z-depth-1-half">
                                        <div class="view zoom ">
                                            <div class="mb-1"><b class="text-left">Rice Flour</b></div>
                                            <img src="img/product-slider/riceflours.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="card-footer px-1">
                                            <span class="float-left font-weight-bold">
